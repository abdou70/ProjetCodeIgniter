...
<header>
	...
	<div class="menu">
		<ul>
			...
			<li class="menu-item hidden"><a href="<?php echo base_url('Client/index');?>" target="_blank">Inserer Un Client</a>
			</li>
			<li class="menu-item hidden"><a href="<?php echo base_url('Compte/index');?>" target="_blank">Inserer Un Compte</a></li>
	...
	<div class="heroe">
		...
		<h1>Bienvenu sur CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

		<h2>Programmer en toute securite </h2>
